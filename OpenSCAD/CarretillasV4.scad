...
difference(){
  ...
  union(){
    ...
    linear_extrude(height=espesor)
       difference(){   
                ...
                minkowski(){
                    ...
                    polygon([[-distBalerosX/2,0],[distBalerosX/2,0],[distBalerosX,-distEntreTorY],[-distBalerosX,-distEntreTorY]]);
            ...
            translate([0,-distEntreTorY])
             circle(d=diamTorBal+tol);
                    ...
                    //perforacionBalero_4
            translate([distBalerosX,-distEntreTorY])
             circle(d=diamTorBal+tol);
    ...
    Poste(altura=alturaPoste+espesor,espesor=espPoste,tol=1,diamShaft=diamTorBal);
         ...
         //translate([0,-distEntreTorY-diamTorBal])
         translate([distBalerosX,-distEntreTorY,-6])
         rotate(90)
         cylinder(d=diamTuerca+tol,h=(espesor-tol*2)*2,$fn=6,center=true);
         
         //tuerca para perforacionBalero_5
